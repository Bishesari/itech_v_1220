...
<div class="relative">
    ...
    peer-focus:-top-2.5 peer-focus:text-sm peer-focus:text-blue-700 dark:peer-focus:text-blue-400 peer-focus:bg-accent-foreground dark:peer-focus:bg-zinc-900
    peer-[:not(:placeholder-shown)]:bg-accent-foreground dark:peer-[:not(:placeholder-shown)]:bg-zinc-900
